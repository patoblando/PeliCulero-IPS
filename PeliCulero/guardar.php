...
//Provisorio, los nombres son uname y mail
...
if($res->num_rows || $res2->num_rows)
  echo -1;
	...
	$_SESSION['vcode'] = '123456'; // PROVISORIO
	$rs = $mysqli->query("select id from users where username ='".$_POST['uname']."' and email ='".$_POST['mail']."'");
